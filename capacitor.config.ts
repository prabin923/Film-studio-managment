...
//
// Entry point is /login (not the marketing landing) so the app opens straight
// on the login/signup screen. /login auto-forwards to /dashboard when the user
// already has a session.
const serverUrl =
  process.env.CAP_SERVER_URL || "https://film-studio-managment-prabin-sharmas-projects.vercel.app/login";
